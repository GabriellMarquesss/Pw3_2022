...
//CARRINHO DE COMPRAS
Route::get('vitrine/carrinho', [\App\Http\Controllers\CarrinhoComprasController::class, 'index'])->name('vitrine.index');
...
Route::get('/vitrine/carrinho', [\App\Http\Controllers\CarrinhoComprasController::class, 'carrinhoLista'])->name('vitrine.carrinho');
